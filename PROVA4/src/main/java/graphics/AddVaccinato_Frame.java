...
public class AddVaccinato_Frame implements ActionListener, MouseListener{
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Inserisci dati richiesti per registrare la vaccinazione effettuata al cittadino ");
		...
		//field per prelevare nome del centro vaccinale in cui si è tenuta la vaccinazione
		...
		//chooser per prelevare la data della vaccinazione nel formato utilizzato dal db
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(43)
							.addComponent(lblNewLabel, GroupLayout.PREFERRED_SIZE, 601, GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(75)
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
								...
								.addComponent(dataVaccinoChooser, GroupLayout.PREFERRED_SIZE, 118, GroupLayout.PREFERRED_SIZE)
								.addComponent(nomeCentroField, GroupLayout.PREFERRED_SIZE, 187, GroupLayout.PREFERRED_SIZE)
								.addComponent(nomeVaccinoBox, GroupLayout.PREFERRED_SIZE, 155, GroupLayout.PREFERRED_SIZE)))
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(228)
							.addComponent(addButton, GroupLayout.PREFERRED_SIZE, 266, GroupLayout.PREFERRED_SIZE)))
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblNewLabel_4)
								.addComponent(nomeVaccinoBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
							.addGap(31)
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(lblNewLabel_5)
								.addComponent(dataVaccinoChooser, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
							.addGap(33)
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblNewLabel_6)
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == addButton) {
			//QUERY DI CONTROLLO SE IL CENTRO VACCINALE è PRESENTE ALL'INTERNO DEL DB, SE PRESENTE ALLORA ESEGUE:
			resultLabel.setText("Inserimento della vaccinazione andato a buon fine");
			resultLabel.setForeground(Color.blue);
			resultLabel.setVisible(true);
			
			//ALTRIMENTI ESEGUE:
			/*resultLabel.setText("Il centro vaccinale inserito non è presente nel database");
