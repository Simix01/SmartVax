...
public class AddCentro_Frame implements ActionListener, MouseListener, FocusListener {
	...
	private void initialize() {
		...
		// box da cui prendere il valore della tipologia di luogo tra via, viale e
		// piazza
		...
		// field da cui prendere il cap della provincia di appartenenza del centro
		// vaccinale
		...
		// box da cui prendere la tipologia del centro vaccinale tra aziendale,
		// ospedaliero e hub
		...
		// label invisibile che diventa visibile e fa vedere il result positivo o
		// negativo dell'inserimento nel database
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup().addGap(109)
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
										.addComponent(tipologiaBox, GroupLayout.PREFERRED_SIZE, 150,
								...
								.addGroup(groupLayout.createSequentialGroup()
										.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
												...
												.addComponent(capField, Alignment.LEADING, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(nomeLuogoField, Alignment.LEADING)
												.addComponent(nomeCentroField, Alignment.LEADING,
														GroupLayout.DEFAULT_SIZE, 257, Short.MAX_VALUE)
												.addComponent(tipoLuogoBox, Alignment.LEADING,
				...
				.addGroup(Alignment.LEADING,
						groupLayout.createSequentialGroup().addGap(156)
								.addComponent(resultLabel, GroupLayout.PREFERRED_SIZE, 371, GroupLayout.PREFERRED_SIZE)
								.addContainerGap(157, Short.MAX_VALUE))
				.addGroup(groupLayout.createSequentialGroup().addContainerGap(568, Short.MAX_VALUE)
						.addComponent(backLabel).addGap(29)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup().addGap(40)
				.addGroup(groupLayout
						.createParallelGroup(Alignment.BASELINE).addComponent(lblNewLabel).addComponent(nomeCentroField,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(44)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(lblNewLabel_1).addComponent(
						tipoLuogoBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addComponent(nomeLuogoField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addComponent(siglaProvField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addComponent(numCivicoField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addComponent(
						capField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(40)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(lblNewLabel_2).addComponent(
						tipologiaBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(37).addComponent(addButton, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
				.addGap(27).addComponent(resultLabel).addPreferredGap(ComponentPlacement.RELATED, 56, Short.MAX_VALUE)
				.addComponent(backLabel).addGap(19)));
