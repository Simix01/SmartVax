...
public class InsertEvent_Frame implements ActionListener, MouseListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InsertEvent_Frame window = new InsertEvent_Frame();
					window.frmInserisciEventoAvverso.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("<html>In questa sezione è possibile inserire eventi avversi riscontrati post vaccinazione;<br>Questi eventi verranno catalogati e suddivisi per centro vaccinale.");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		
		//campo per prelevare tipologia evento avverso
		eventBox = new JComboBox();
		eventBox.setModel(new DefaultComboBoxModel(new String[] {"Febbre", "Mal di testa", "Mal di gola", "Spossatezza", "Dolori intestinali", "Dolori muscolari", "Tosse", "Perdita del gusto o dell'olfatto", "Diarrea", "Difficoltà respiratoria"}));
		
		JLabel lblNewLabel_1 = new JLabel("Evento avverso: ");
		
		JLabel lblNewLabel_2 = new JLabel("Gravità: ");
		...
		//campo per prelevare nome del centro su cui fare una ricerca per verificare che la persona si sia vaccinata nel centro vaccinale
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(lblNewLabel, GroupLayout.PREFERRED_SIZE, 627, GroupLayout.PREFERRED_SIZE))
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
						...
						.addComponent(gravitaField, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE)
						.addComponent(eventBox, 0, 305, Short.MAX_VALUE)
				...
				.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
					...
					.addComponent(confirmButton, GroupLayout.PREFERRED_SIZE, 186, GroupLayout.PREFERRED_SIZE)
					.addGap(217))
		);
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblNewLabel_4)
						.addComponent(centroField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(43)
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblNewLabel_2)
								.addComponent(gravitaField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
							.addGap(43))
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblNewLabel_1)
								.addComponent(eventBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
							.addGap(100)))
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblNewLabel_3)
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == confirmButton) {
			//SE LA QUERY DI CONTROLLO SUL VACCINATO NEL CENTRO VACCINALE VA A BUON FINE ALLORA SI ESEGUE QUESTO
			resultLabel.setText("L'inserimento è andato a buon fine");
			resultLabel.setForeground(Color.blue);
			resultLabel.setVisible(true);
			
			//SE LA QUERY RESTITUISCE ESITO NEGATIVO ALLORA SI ESEGUE QUESTO
			/*resultLabel.setText("L'inserimento non è andato a buon fine, ricontrolla i dati inseriti");
